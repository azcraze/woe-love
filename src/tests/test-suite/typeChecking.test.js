...
describe('is function', () => {
  ...
  it('should return false for string type if data is not a string', () => {
    expect(is('string', 123)).toEqual({ isValid: false, errMsg: 'Expected string, but got number: 123' });
  });
  ...
  it('should return false for number type if data is not a number', () => {
    expect(is('number', 'hello')).toEqual({ isValid: false, errMsg: 'Expected number, but got string: hello' });
  });
  ...
  it('should return false for array type if data is not an array', () => {
    expect(is('array', 'hello')).toEqual({ isValid: false, errMsg: 'Expected array, but got string: hello' });
  });
  ...
  it('should return false for object type if data is not an object', () => {
    expect(is('object', 'hello')).toEqual({ isValid: false, errMsg: 'Expected object, but got string: hello' });
  });
  ...
  it('should return false for function type if data is not a function', () => {
    expect(is('function', 'hello')).toEqual({ isValid: false, errMsg: 'Expected function, but got string: hello' });
  });
  ...
  it('should return false for null type if data is not null', () => {
    expect(is('null', 'hello')).toEqual({ isValid: false, errMsg: 'Expected null, but got string: hello' });
  });
  ...
  it('should return false for undefined type if data is defined', () => {
    ...
    expect(is('undefined', data)).toEqual({ isValid: false, errMsg: `Expected undefined, but got ${typeof data}: hello` });
  });
  ...
  it('should return false for boolean type if data is not a boolean', () => {
    expect(is('boolean', 'hello')).toEqual({ isValid: false, errMsg: 'Expected boolean, but got string: hello' });
  });
