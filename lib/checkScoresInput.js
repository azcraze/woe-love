...
require("rootpath")();
const { NameExists } = require("./checkUserExists");
...
const errorMessages = {
  inputValidation: {
    ...
    5: "Player is not a registered name",
  },
  scoreboard: {
...
function processRKInput(inputString) {
  ...
  if (!NameExists(playerName)) {
    const errorMessage = getErrorMessage("inputValidation", "5");
...
// EXAMPLE -
const inputString = 'pookie 10 20';
